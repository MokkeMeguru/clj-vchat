...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__79397 = cljs.core.instance_QMARK_;
var expr__79398 = reactive_val;
if(cljs.core.truth_(pred__79397.call(null,reagent.ratom.RAtom,expr__79398))){
return "ra";
} else {
if(cljs.core.truth_(pred__79397.call(null,reagent.ratom.RCursor,expr__79398))){
return "rc";
} else {
if(cljs.core.truth_(pred__79397.call(null,reagent.ratom.Reaction,expr__79398))){
return "rx";
} else {
if(cljs.core.truth_(pred__79397.call(null,reagent.ratom.Track,expr__79398))){
return "tr";
} else {
return "other";
}
