...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__78474){
var map__78475 = p__78474;
var map__78475__$1 = ((((!((map__78475 == null)))?(((((map__78475.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78475.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__78475):map__78475);
var handler = cljs.core.get.call(null,map__78475__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return (function (p1__78477_SHARP_){
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__3922__auto__ = p1__78477_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__78478){
var map__78479 = p__78478;
var map__78479__$1 = ((((!((map__78479 == null)))?(((((map__78479.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78479.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__78479):map__78479);
var request = map__78479__$1;
var interceptors = cljs.core.get.call(null,map__78479__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
