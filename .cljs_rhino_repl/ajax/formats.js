...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__78391){
var map__78392 = p__78391;
var map__78392__$1 = ((((!((map__78392 == null)))?(((((map__78392.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78392.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__78392):map__78392);
var request = map__78392__$1;
var response_format = cljs.core.get.call(null,map__78392__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
ajax.formats.accept_header = (function ajax$formats$accept_header(p__78397){
var map__78398 = p__78397;
var map__78398__$1 = ((((!((map__78398 == null)))?(((((map__78398.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78398.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__78398):map__78398);
var request = map__78398__$1;
var response_format = cljs.core.get.call(null,map__78398__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
