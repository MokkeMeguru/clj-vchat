...
return cljs.core.assoc.call(null,G__72657,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__72657;
}
});
...
var len__4499__auto___72662 = arguments.length;
var i__4500__auto___72663 = (0);
while(true){
if((i__4500__auto___72663 < len__4499__auto___72662)){
args__4502__auto__.push((arguments[i__4500__auto___72663]));

var G__72664 = (i__4500__auto___72663 + (1));
i__4500__auto___72663 = G__72664;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq72659){
var G__72660 = cljs.core.first.call(null,seq72659);
var seq72659__$1 = cljs.core.next.call(null,seq72659);
var G__72661 = cljs.core.first.call(null,seq72659__$1);
var seq72659__$2 = cljs.core.next.call(null,seq72659__$1);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__72660,G__72661,seq72659__$2);
});
...
var map__72666 = m;
var map__72666__$1 = ((((!((map__72666 == null)))?(((((map__72666.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__72666.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__72666):map__72666);
var file = cljs.core.get.call(null,map__72666__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__72666__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__72666__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__72666,map__72666__$1,file,line,column){
return (function (p1__72665_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__72665_SHARP_));
});})(map__72666,map__72666__$1,file,line,column))
...
var temp__5457__auto___72668 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___72668)){
var message_72669 = temp__5457__auto___72668;
cljs.core.println.call(null,message_72669);
} else {
}
...
var temp__5457__auto___72670 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___72670)){
var message_72671 = temp__5457__auto___72670;
cljs.core.println.call(null,message_72671);
} else {
}
...
var output_dir = ".cljs_rhino_repl";
var output_dir__$1 = (function (){var G__72672 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__72672),"/"].join('');
} else {
return G__72672;
}
})();
...
var G__72674 = exception.stack;
var G__72674__$1 = (((G__72674 == null))?null:clojure.string.split_lines.call(null,G__72674));
var G__72674__$2 = (((G__72674__$1 == null))?null:cljs.core.get.call(null,G__72674__$1,depth));
if((G__72674__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__72674__$2);
}
} else {
...
var vec__72675 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__72675,(0),null);
var column = cljs.core.nth.call(null,vec__72675,(1),null);
var vec__72678 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__72678,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__72678,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__72678,(2),null);
...
var m__$1 = (function (){var G__72681 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__72681__$1 = (((G__72681 instanceof cljs.core.Keyword))?G__72681.fqn:null);
switch (G__72681__$1) {
case "fail":
...
var G__72685 = (function (){var G__72684 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__72684);
} else {
return G__72684;
}
})();
...
return cljs.core.vary_meta.call(null,G__72686,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e72687){var e = e72687;
var G__72688 = e;
var G__72688__$1 = (((G__72688 instanceof cljs.core.Keyword))?G__72688.fqn:null);
switch (G__72688__$1) {
...
var vec__72690 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__72690,(0),null);
var types = vec__72690;
...
return cljs.core.map.call(null,(function (p__72693){
var vec__72694 = p__72693;
var ns = cljs.core.nth.call(null,vec__72694,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__72694,(1),null);
return ((function (vec__72694,ns,vars__$1){
return (function (){
...
var G__72697 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__72697,G__72697__$1,env,once_fixtures,each_fixtures,vec__72694,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__72697,G__72697__$1,env,once_fixtures,each_fixtures,vec__72694,ns,vars__$1){
return (function (){
var seq__72698 = cljs.core.seq.call(null,vars__$1);
var chunk__72699 = null;
var count__72700 = (0);
var i__72701 = (0);
while(true){
if((i__72701 < count__72700)){
var v = cljs.core._nth.call(null,chunk__72699,i__72701);
var temp__5457__auto___72703 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___72703)){
var t_72704 = temp__5457__auto___72703;
each_fixture_fn.call(null,((function (seq__72698,chunk__72699,count__72700,i__72701,t_72704,temp__5457__auto___72703,v,each_fixture_fn,G__72697,G__72697__$1,env,once_fixtures,each_fixtures,vec__72694,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_72704)));
});})(seq__72698,chunk__72699,count__72700,i__72701,t_72704,temp__5457__auto___72703,v,each_fixture_fn,G__72697,G__72697__$1,env,once_fixtures,each_fixtures,vec__72694,ns,vars__$1))
);
} else {
}


var G__72705 = seq__72698;
var G__72706 = chunk__72699;
var G__72707 = count__72700;
var G__72708 = (i__72701 + (1));
seq__72698 = G__72705;
chunk__72699 = G__72706;
count__72700 = G__72707;
i__72701 = G__72708;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__72698);
if(temp__5457__auto__){
var seq__72698__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__72698__$1)){
var c__4319__auto__ = cljs.core.chunk_first.call(null,seq__72698__$1);
var G__72709 = cljs.core.chunk_rest.call(null,seq__72698__$1);
var G__72710 = c__4319__auto__;
var G__72711 = cljs.core.count.call(null,c__4319__auto__);
var G__72712 = (0);
seq__72698 = G__72709;
chunk__72699 = G__72710;
count__72700 = G__72711;
i__72701 = G__72712;
continue;
} else {
var v = cljs.core.first.call(null,seq__72698__$1);
var temp__5457__auto___72713__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___72713__$1)){
var t_72714 = temp__5457__auto___72713__$1;
each_fixture_fn.call(null,((function (seq__72698,chunk__72699,count__72700,i__72701,t_72714,temp__5457__auto___72713__$1,v,seq__72698__$1,temp__5457__auto__,each_fixture_fn,G__72697,G__72697__$1,env,once_fixtures,each_fixtures,vec__72694,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_72714)));
});})(seq__72698,chunk__72699,count__72700,i__72701,t_72714,temp__5457__auto___72713__$1,v,seq__72698__$1,temp__5457__auto__,each_fixture_fn,G__72697,G__72697__$1,env,once_fixtures,each_fixtures,vec__72694,ns,vars__$1))
);
} else {
}


var G__72715 = cljs.core.next.call(null,seq__72698__$1);
var G__72716 = null;
var G__72717 = (0);
var G__72718 = (0);
seq__72698 = G__72715;
chunk__72699 = G__72716;
count__72700 = G__72717;
i__72701 = G__72718;
continue;
}
} else {
...
});})(each_fixture_fn,G__72697,G__72697__$1,env,once_fixtures,each_fixtures,vec__72694,ns,vars__$1))
);
});})(each_fixture_fn,G__72697,G__72697__$1,env,once_fixtures,each_fixtures,vec__72694,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__72697__$1)].join('')));

}
})());
});
;})(vec__72694,ns,vars__$1))
