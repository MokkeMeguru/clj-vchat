...
var G__71282 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__71282;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__71283 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__71283,ch);
...
if(("\\" === ch__$1)){
var ch_71284__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_71284__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_71284__$2);
} else {
}

var G__71285 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__71285;
continue;
}
}
...
var vec__71293 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__71293,(0),null);
var start_column = cljs.core.nth.call(null,vec__71293,(1),null);
...
var G__71296 = cljs.core.conj_BANG_.call(null,a,form);
a = G__71296;
continue;
}
}
...
var _STAR_read_delim_STAR_71297 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_71297;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__71298 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__71298,(0),null);
var start_column = cljs.core.nth.call(null,vec__71298,(1),null);
...
var vec__71301 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__71301,(0),null);
var end_column = cljs.core.nth.call(null,vec__71301,(1),null);
...
var vec__71304 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__71304,(0),null);
var start_column = cljs.core.nth.call(null,vec__71304,(1),null);
...
var vec__71307 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__71307,(0),null);
var end_column = cljs.core.nth.call(null,vec__71307,(1),null);
...
var vec__71310 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__71310,(0),null);
var start_column = cljs.core.nth.call(null,vec__71310,(1),null);
...
var vec__71313 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__71313,(0),null);
var end_column = cljs.core.nth.call(null,vec__71313,(1),null);
...
var sb = (function (){var G__71316 = (new goog.string.StringBuffer());
G__71316.append(initch);
...
var G__71318 = (function (){var G__71317 = sb;
G__71317.append(ch);

return G__71317;
})();
var G__71319 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__71318;
ch = G__71319;
continue;
}
...
switch (G__71322) {
case "\\":
var G__71326 = (function (){var G__71323 = sb;
G__71323.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__71323;
})();
var G__71327 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__71326;
ch = G__71327;
continue;
...
break;
default:
var G__71328 = (function (){var G__71324 = sb;
G__71324.append(ch);

return G__71324;
})();
var G__71329 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__71328;
ch = G__71329;
continue;
...
var vec__71330 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__71330,(0),null);
var end_column = cljs.core.nth.call(null,vec__71330,(1),null);
...
var vec__71333 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__71333,(0),null);
var column = cljs.core.nth.call(null,vec__71333,(1),null);
...
var vec__71338 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__71338,(0),null);
var column = cljs.core.nth.call(null,vec__71338,(1),null);
...
var vec__71343 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__71343,(0),null);
var column = cljs.core.nth.call(null,vec__71343,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__71348 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__71348,(0),null);
var start_column = cljs.core.nth.call(null,vec__71348,(1),null);
...
var vec__71351 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__71351,(0),null);
var end_column = cljs.core.nth.call(null,vec__71351,(1),null);
...
var G__71354 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__71354,true,null,opts,pending_forms);
...
var G__71355 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__71355)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__71355)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__71355)){
...
var _STAR_suppress_read_STAR_71356 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_71356;
}});
...
var G__71357 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__71357,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__71357,rdr,first_line);
...
var G__71361 = matched;
var G__71362 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__71361;
finished = G__71362;
continue;
} else {
...
var _STAR_suppress_read_STAR_71363 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_71363;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env71364 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__71365 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__71365,"(");
...
var G__71366 = (i + (1));
var G__71367 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env71364;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__71368 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__71368);
...
var G__71369 = cljs.core.next.call(null,s__$1);
var G__71370 = ret;
s__$1 = G__71369;
r = G__71370;
continue;
...
var G__71371 = cljs.core.next.call(null,s);
var G__71372 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__71371;
key_vals = G__71372;
continue;
} else {
...
var gensym_env71376 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env71376;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__71377 = token;
var G__71377__$1 = (((G__71377 == null))?null:cljs.core.subs.call(null,G__71377,(1)));
var G__71377__$2 = (((G__71377__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__71377__$1));
var G__71377__$3 = (((G__71377__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__71377__$2));
var G__71377__$4 = (((G__71377__$3 == null))?null:cljs.core.symbol.call(null,G__71377__$3));
if((G__71377__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__71377__$4);
}
})():(function (){var G__71378 = token;
var G__71378__$1 = (((G__71378 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__71378));
if((G__71378__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__71378__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e71385){if((e71385 instanceof Error)){
var e = e71385;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__71389,reader){
...
var opts = map__71390__$1;
var eof = cljs.core.get.call(null,map__71390__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___71398 = arguments.length;
var i__4500__auto___71399 = (0);
while(true){
if((i__4500__auto___71399 < len__4499__auto___71398)){
args__4502__auto__.push((arguments[i__4500__auto___71399]));

var G__71400 = (i__4500__auto___71399 + (1));
i__4500__auto___71399 = G__71400;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq71396){
var G__71397 = cljs.core.first.call(null,seq71396);
var seq71396__$1 = cljs.core.next.call(null,seq71396);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__71397,seq71396__$1);
});
