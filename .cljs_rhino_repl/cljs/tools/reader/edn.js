...
var G__71407 = (function (){var G__71405 = sb;
G__71405.append(cljs.tools.reader.reader_types.read_char.call(null,rdr));

return G__71405;
})();
var G__71408 = cljs.tools.reader.reader_types.peek_char.call(null,rdr);
sb = G__71407;
ch = G__71408;
continue;
}
...
var temp__5455__auto____$2 = cljs.tools.reader.edn.read_tagged.call(null,(function (){var G__71409 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__71409,ch);
...
var vec__71417 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__71417,(0),null);
var start_column = cljs.core.nth.call(null,vec__71417,(1),null);
...
var G__71421 = ((!((mret === rdr)))?cljs.core.conj_BANG_.call(null,a,mret):a);
a = G__71421;
continue;
} else {
var o = cljs.tools.reader.edn.read.call(null,(function (){var G__71420 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__71420,ch);

return G__71420;
})(),true,null,opts);
var G__71422 = ((!((o === rdr)))?cljs.core.conj_BANG_.call(null,a,o):a);
a = G__71422;
continue;
}
}
...
var vec__71423 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__71423,(0),null);
var start_column = cljs.core.nth.call(null,vec__71423,(1),null);
...
var sb = (function (){var G__71426 = (new goog.string.StringBuffer());
G__71426.append(initch);
...
var G__71428 = (function (){var G__71427 = sb;
G__71427.append(ch);

return G__71427;
})();
var G__71429 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__71428;
ch = G__71429;
continue;
}
...
while(true){
var G__71432 = ch;
if(cljs.core._EQ_.call(null,null,G__71432)){
...
if(cljs.core._EQ_.call(null,"\\",G__71432)){
var G__71435 = (function (){var G__71433 = sb;
G__71433.append(cljs.tools.reader.edn.escape_char.call(null,sb,rdr));

return G__71433;
})();
var G__71436 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__71435;
ch = G__71436;
continue;
} else {
...
var G__71437 = (function (){var G__71434 = sb;
G__71434.append(ch);

return G__71434;
})();
var G__71438 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__71437;
ch = G__71438;
continue;
...
var G__71442 = rdr;
cljs.tools.reader.edn.read.call(null,G__71442,true,null,true);
...
var temp__5455__auto__ = (function (){var G__71443 = token;
var G__71443__$1 = (((G__71443 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__71443));
if((G__71443__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__71443__$1);
}
})();
if(cljs.core.truth_(temp__5455__auto__)){
...
var G__71444 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__71444)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__71444)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__71444)){
...
cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$2 = (function (p__71451,reader){
var map__71452 = p__71451;
var map__71452__$1 = ((((!((map__71452 == null)))?(((((map__71452.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__71452.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__71452):map__71452);
var opts = map__71452__$1;
var eof = cljs.core.get.call(null,map__71452__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
...
}catch (e71454){if((e71454 instanceof Error)){
var e = e71454;
