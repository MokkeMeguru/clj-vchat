...
if((i < len)){
var k = (ks[i]);
var G__76994 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__76995 = (i + (1));
m = G__76994;
i = G__76995;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__76997 = c;
var G__76997__$1 = (((G__76997 == null))?null:G__76997.prototype);
if((G__76997__$1 == null)){
return null;
} else {
return (G__76997__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__76999 = c;
var G__76999__$1 = (((G__76999 == null))?null:G__76999.prototype);
if((G__76999__$1 == null)){
return null;
} else {
return (G__76999__$1["render"]);
}
})() == null))));
});
...
return (function() { 
var G__77002__delegate = function (args){
return reagent.impl.component.as_element.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
var G__77002 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__77003__i = 0, G__77003__a = new Array(arguments.length -  0);
while (G__77003__i < G__77003__a.length) {G__77003__a[G__77003__i] = arguments[G__77003__i + 0]; ++G__77003__i;}
  args = new cljs.core.IndexedSeq(G__77003__a,0,null);
} 
return G__77002__delegate.call(this,args);};
G__77002.cljs$lang$maxFixedArity = 0;
G__77002.cljs$lang$applyTo = (function (arglist__77004){
var args = cljs.core.seq(arglist__77004);
return G__77002__delegate(args);
});
G__77002.cljs$core$IFn$_invoke$arity$variadic = G__77002__delegate;
return G__77002;
})()
;})(c,f,_,res))
:res);
...
var _STAR_current_component_STAR_77006 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_77006;
}});
...
var G__77007 = key;
var G__77007__$1 = (((G__77007 instanceof cljs.core.Keyword))?G__77007.fqn:null);
switch (G__77007__$1) {
...
return ((function (G__77007,G__77007__$1){
...
var c = this;
var G__77008_77010 = (c["cljsRatom"]);
if((G__77008_77010 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__77008_77010);
}
...
var renders_77012 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_77013 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_77012));
if((cljs.core.count.call(null,renders_77012) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_77012))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_77013)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_77013))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__77011 = name;
switch (G__77011) {
case "":
...
var G__77015 = o;
(G__77015[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__77016 = fiber;
var G__77016__$1 = (((G__77016 == null))?null:(G__77016["type"]));
if((G__77016__$1 == null)){
return null;
} else {
return (G__77016__$1["displayName"]);
}
})();
var parent = (function (){var G__77017 = fiber;
if((G__77017 == null)){
return null;
} else {
return (G__77017["return"]);
}
})();
var path = (function (){var G__77018 = parent;
var G__77018__$1 = (((G__77018 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__77018));
if((G__77018__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__77018__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3922__auto__ = (function (){var G__77020 = c;
if((G__77020 == null)){
return null;
} else {
return (G__77020["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__77021._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3922__auto__ = (function (){var G__77023 = c;
if((G__77023 == null)){
return null;
} else {
return (G__77023["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var or__3922__auto____$1 = (function (){var G__77025 = c;
if((G__77025 == null)){
return null;
} else {
return G__77025._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3922__auto__ = (function (){var G__77027 = instance;
if((G__77027 == null)){
return null;
} else {
return (G__77027["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var G__77028 = instance;
if((G__77028 == null)){
return null;
} else {
return G__77028._currentElement;
}
}
})();
var name = (function (){var G__77029 = elem;
var G__77029__$1 = (((G__77029 == null))?null:(G__77029["type"]));
if((G__77029__$1 == null)){
return null;
} else {
return (G__77029__$1["displayName"]);
}
})();
var owner = (function (){var or__3922__auto__ = (function (){var G__77031 = elem;
if((G__77031 == null)){
return null;
} else {
return (G__77031["_owner"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__77032._owner;
}
}
})();
var path = (function (){var G__77033 = owner;
var G__77033__$1 = (((G__77033 == null))?null:reagent.impl.component.component_path.call(null,G__77033));
if((G__77033__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__77033__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__77034 = c;
var G__77034__$1 = (((G__77034 == null))?null:G__77034.constructor);
if((G__77034__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__77034__$1);
}
}
})();
