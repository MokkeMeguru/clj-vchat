...
var len__4499__auto___78571 = arguments.length;
var i__4500__auto___78572 = (0);
while(true){
if((i__4500__auto___78572 < len__4499__auto___78571)){
args__4502__auto__.push((arguments[i__4500__auto___78572]));

var G__78573 = (i__4500__auto___78572 + (1));
i__4500__auto___78572 = G__78573;
continue;
} else {
}
break;
...
/** @this {Function} */
markdown.common.freeze_string.cljs$lang$applyTo = (function (seq78570){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq78570));
});
...
var G__78576 = cljs.core.reduce.call(null,((function (text,state,matches,temp__5455__auto__){
return (function (s,r){
...
return (function (p1__78574_SHARP_){
return cljs.core.get.call(null,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__78574_SHARP_,p1__78574_SHARP_);
});})(text,state,matches,temp__5455__auto__))
);
});})(text,state,matches,temp__5455__auto__))
,text,matches);
var G__78577 = cljs.core.update.call(null,state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__5455__auto__){
return (function (p1__78575_SHARP_){
return cljs.core.apply.call(null,cljs.core.dissoc,p1__78575_SHARP_,matches);
});})(text,state,matches,temp__5455__auto__))
);
text = G__78576;
state = G__78577;
...
var vec__78580 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__78583 = transformer.call(null,clojure.string.join.call(null,buf),cur_state);
var s = cljs.core.nth.call(null,vec__78583,(0),null);
var new_state = cljs.core.nth.call(null,vec__78583,(1),null);
...
var new_buf = cljs.core.nth.call(null,vec__78580,(0),null);
var new_state = cljs.core.nth.call(null,vec__78580,(1),null);
var G__78587 = cljs.core.vec.call(null,cljs.core.concat.call(null,out,cljs.core.seq.call(null,open),new_buf,cljs.core.seq.call(null,close)));
var G__78588 = cljs.core.PersistentVector.EMPTY;
var G__78589 = cljs.core.rest.call(null,tokens);
var G__78590 = cljs.core.assoc.call(null,new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__78587;
buf = G__78588;
tokens = G__78589;
cur_state = G__78590;
...
var G__78591 = out;
var G__78592 = cljs.core.into.call(null,buf,cljs.core.first.call(null,tokens));
var G__78593 = cljs.core.rest.call(null,tokens);
var G__78594 = cur_state;
out = G__78591;
buf = G__78592;
tokens = G__78593;
cur_state = G__78594;
...
var G__78595 = out;
var G__78596 = buf;
var G__78597 = cljs.core.rest.call(null,tokens);
var G__78598 = cljs.core.assoc.call(null,cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__78595;
buf = G__78596;
tokens = G__78597;
cur_state = G__78598;
...
var G__78599 = cljs.core.into.call(null,out,cljs.core.first.call(null,tokens));
var G__78600 = buf;
var G__78601 = cljs.core.rest.call(null,tokens);
var G__78602 = cur_state;
out = G__78599;
buf = G__78600;
tokens = G__78601;
cur_state = G__78602;
...
var num_hashes = cljs.core.count.call(null,cljs.core.filter.call(null,(function (p1__78603_SHARP_){
return cljs.core.not_EQ_.call(null," ",p1__78603_SHARP_);
}),cljs.core.take_while.call(null,(function (p1__78604_SHARP_){
return ((cljs.core._EQ_.call(null,"#",p1__78604_SHARP_)) || (cljs.core._EQ_.call(null," ",p1__78604_SHARP_)));
